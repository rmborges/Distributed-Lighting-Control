...
server_prof_multi: server_prof_multi.cpp
	g++ -std=c++11 server_prof_multi.cpp serial_send.cpp i2c_receive.cpp arduino.cpp messages.cpp -o server_prof_multi -pthread -lpthread -lboost_system -lboost_thread -lpigpio -lrt -lstdc++
